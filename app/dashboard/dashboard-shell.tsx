  ...
  return (
    <div className="min-h-screen bg-[#0B0F4E] text-white flex selection:bg-blue-500/30">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative bg-[#F8F9FA] text-slate-900">
        <header className="h-14 sm:h-16 flex items-center justify-between lg:justify-end px-3 sm:px-6 border-b border-gray-200 bg-white z-40 sticky top-0 shrink-0 shadow-sm relative">
