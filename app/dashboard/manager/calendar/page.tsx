            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-[500px] flex flex-col max-h-[90vh] overflow-hidden" onClick={e => e.stopPropagation()}>
              ...
              <div className="px-6 py-4 overflow-y-auto max-h-[600px] flex flex-col gap-4 bg-white">
                ...
                {leaveEvents.map((evt: any, idx: number) => {
                  const leave = evt.raw;
                  return (
                    <div key={`leave-${idx}`} className="flex flex-col gap-2 p-4 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white group">
