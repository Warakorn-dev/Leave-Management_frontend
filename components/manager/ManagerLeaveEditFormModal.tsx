...
interface ManagerLeaveEditFormModalProps {
  username: string;
  department?: string;
  positionName?: string;
  editForm: ManagerLeaveEditForm;
  setEditForm: React.Dispatch<React.SetStateAction<ManagerLeaveEditForm>>;
...
/** Fullscreen leave-request edit form used by the manager leave-history "แก้ไขข้อมูล" flow. */
export function ManagerLeaveEditFormModal({
  username,
  department,
  positionName,
  editForm,
  ...
  onFileChange,
  onRemoveFile,
}: ManagerLeaveEditFormModalProps) {
  return (
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <form onSubmit={onSubmit} className="space-y-8 text-black">
            ...
            <div>
              ...
              <div className="relative group border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-gray-500 bg-[#FAFAFA] hover:bg-gray-50 transition-colors cursor-pointer overflow-hidden">
                <Upload
